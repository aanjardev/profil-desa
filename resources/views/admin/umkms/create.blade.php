...
@section('page_title', 'Tambah Data UMKM')
@section('page_subtitle', 'Masukkan informasi detail mengenai UMKM unggulan desa.')
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category') }}" maxlength="100"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
                        ...
                        <div>
                            ...
                            <input type="text" name="owner_name" id="owner_name" value="{{ old('owner_name') }}" maxlength="255"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="8" required
                                  ...
                                  placeholder="Ceritakan produk/jasa, keunggulan, dan hal menarik dari UMKM ini...">{{ old('description') }}</textarea>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="url" name="marketplace_link" id="marketplace_link" value="{{ old('marketplace_link') }}" maxlength="255"
                               class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
                    ...
                    <div>
                        ...
                        <textarea name="facilities" id="facilities" rows="3"
                                  class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
                                  placeholder="Contoh: Keripik Singkong Balado, Keripik Pisang Coklat, Kue Kering Lebaran">{{ old('facilities') }}</textarea>
