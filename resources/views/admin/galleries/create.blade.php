...
@section('page_subtitle', 'Unggah gambar baru ke dalam galeri dokumentasi desa.')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
        ...
        <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <!-- Upload Area -->
                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Upload Gambar <span class="text-red-500">*</span></label>
                    
                    <div class="relative group cursor-pointer">
                        <input type="file" name="image" id="image" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" required accept="image/jpeg,image/png,image/jpg,image/webp" onchange="previewImage(this)">
                        
                        <div id="upload-placeholder" class="border-2 border-dashed border-gray-300 rounded-xl p-8 flex flex-col items-center justify-center text-center bg-gray-50 group-hover:bg-blue-50 group-hover:border-blue-300 transition-colors">
                            ...
                            <p class="text-sm font-semibold text-gray-700 mb-1 group-hover:text-blue-700">Klik atau drag gambar ke sini</p>
                        ...
                        <!-- Preview Area -->
                        <div id="image-preview-container" class="hidden relative rounded-xl overflow-hidden border border-gray-200 bg-gray-100 aspect-video w-full">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Contoh: Kegiatan Kerja Bakti Warga" 
                           maxlength="100"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" placeholder="Tuliskan keterangan singkat mengenai gambar ini..."
                              maxlength="500"
                              class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm resize-none">{{ old('description') }}</textarea>
                </div>
