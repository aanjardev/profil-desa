...
@section('page_subtitle', 'Tambahkan daftar pertanyaan dan jawaban baru untuk membantu warga.')
        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="question" id="question" value="{{ old('question') }}" placeholder="Contoh: Apa syarat membuat KTP baru?" 
                    ...
                    <div class="flex flex-col lg:flex-row gap-6">
                        ...
                        <div class="flex-1">
                            <textarea name="answer" id="answer" rows="10" placeholder="Tuliskan jawaban lengkap di sini..."
                                      ...
                                      class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm resize-y leading-relaxed font-mono">{{ old('answer') }}</textarea>
                        </div>
