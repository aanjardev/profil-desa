...
@section('page_subtitle', 'Tambahkan informasi acara atau kegiatan desa yang akan datang.')
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select name="category" id="category" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm">
                                ...
                                <option value="Kebudayaan" {{ old('category') == 'Kebudayaan' ? 'selected' : '' }}>Kebudayaan</option>
                                <option value="Lainnya" {{ old('category', 'Lainnya') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" required
                                  ...
                                  placeholder="Deskripsikan tentang acara ini...">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="audience" id="audience" value="{{ old('audience', 'Umum') }}" maxlength="255"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
                        ...
                        <div>
                            ...
                            <input type="text" name="organizer" id="organizer" value="{{ old('organizer') }}" maxlength="255"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
