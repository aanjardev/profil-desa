...
@section('page_title', 'Agenda Desa')
@section('page_subtitle', 'Kelola jadwal acara dan kegiatan desa untuk warga.')
...
<div class="bg-white p-4 md:p-6 rounded-xl border border-gray-100 shadow-sm mb-6 flex flex-col gap-4">
    <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
        <form action="{{ route('admin.agendas.index') }}" method="GET" class="w-full xl:flex-1 flex flex-col lg:flex-row gap-3">
        <!-- Search -->
        ...
        <div class="flex flex-col sm:flex-row gap-3 w-full xl:w-auto shrink-0 pt-4 xl:pt-0 border-t xl:border-t-0 border-gray-100">
            <a href="{{ route('admin.agendas.archives') }}" class="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-white border border-gray-200 text-gray-700 text-sm font-semibold rounded-lg hover:bg-gray-50 transition-colors shadow-sm focus:ring-2 focus:ring-gray-200 shrink-0 w-full sm:w-auto">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <h3 class="text-base font-bold text-gray-900 mb-1">Belum ada agenda ditemukan</h3>
                            <p class="text-sm text-gray-500 mb-4">Mulai bagikan jadwal acara atau kegiatan desa Anda.</p>
                            <a href="{{ route('admin.agendas.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-100 transition-colors">
                                Tambah Agenda
                            </a>
                        </div>
                    </td>
