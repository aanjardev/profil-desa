...
<html lang="en" class="no-js">
    ...
    <body>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="{{ route('template23.faq') }}">FAQ</a></li>
        ...
        <script type="text/javascript" src="{{ asset('23/js/components/faq.min.js') }}"></script>
        <!--========== END JAVASCRIPTS ==========-->
