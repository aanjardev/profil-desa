...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- Theme Skins -->
        <link href="{{ asset('23/css/theme/gold.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <body>
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="{{ route('template23.index') }}" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="{{ asset('23/img/logo-gold.png') }}" alt="Megakit Logo">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="{{ asset('23/img/logo-gold-dark.png') }}" alt="Megakit Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.index') }}">Corporate</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.index-app-landing') }}">App Landing</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.index-portfolio') }}">Portfolio</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.index-events') }}">Events</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair -is-active" href="{{ route('template23.index-lawyer') }}">Lawyer</a></li>
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.index-coming-soon') }}">Coming Soon</a></li>
                        </ul>
                        <!-- End Menu List -->

                        <!-- Menu List -->                                
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.about') }}">About</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.team') }}">Team</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.services') }}">Services</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.events') }}">Events</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.faq') }}">FAQ</a></li>
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider g-font-family--playfair" href="{{ route('template23.contacts') }}">Contacts</a></li>
                        </ul>
                        <!-- End Menu List -->
                    </div>
                </nav>
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="g-fullheight--xs js__parallax-window" style="background: url('{{ asset('23/1920x1080/11.jpg') }}') 50% 0 no-repeat fixed; background-size: cover;">
            ...
            <div class="row g-hor-centered-row--md">
                ...
                <div class="col-md-4 col-xs-6 col-xs-offset-3 g-full-width--xs g-full-width-offset-0--xs g-hor-centered-row__col">
                    <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="{{ asset('23/img/450x700/01.jpg') }}" alt="Image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="clearfix">
            ...
            <div class="g-container--sm center-block g-margin-b-125--xs">
                <div class="wow fadeInUp" data-wow-duration=".3" data-wow-delay=".1s">
                    <img class="img-responsive" src="{{ asset('23/img/mockups/items-01.png') }}" alt="Mockup Image">
                </div>
            </div>
        ...
        <!-- Parallax -->
        <div class="js__parallax-window" style="background: url('{{ asset('23/1920x1080/12.jpg') }}') 50% 0 no-repeat fixed;">
        ...
        <div class="container g-margin-t-o-100--xs g-margin-b-125--xs">
            <div class="row g-row-col--0">
                <div class="col-sm-6">
                    <!-- Filter -->
                    <div class="g-bg-position--center g-padding-x-30--xs g-padding-x-40--sm g-padding-y-30--xs g-padding-y-40--sm js__tab-eqaul-height-v1" style="background: url('{{ asset('23/970x970/04.jpg') }}') no-repeat;">
                    ...
                    <div class="swiper-wrapper g-margin-b-50--xs">
                        <div class="swiper-slide g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                <img class="g-width-70--xs g-height-70--xs g-hor-border-4__solid--white g-box-shadow__primary-v1 g-radius--circle g-margin-b-30--xs" src="{{ asset('23/img/400x400/04.jpg') }}" alt="Image">
                        ...
                        <div class="swiper-slide g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                <img class="g-width-70--xs g-height-70--xs g-hor-border-4__solid--white g-box-shadow__primary-v1 g-radius--circle g-margin-b-30--xs" src="{{ asset('23/img/400x400/05.jpg') }}" alt="Image">
                                <div class="g-margin-b-40--xs">
                                    <p class="g-font-size-22--xs g-font-size-28--sm g-font-family--playfair g-color--heading"><i>" I have purchased many great templates over the years but this product and this company have taken it to the next level. Exceptional customizability. "</i></p>
                                </div>
                                <div class="center-block g-hor-divider__solid--heading-light g-width-100--xs g-margin-b-30--xs"></div>
                        ...
                        <div class="swiper-slide g-padding-x-130--sm g-padding-x-150--lg">
                            <div class="g-padding-x-20--xs g-padding-x-50--lg">
                                <img class="g-width-70--xs g-height-70--xs g-hor-border-4__solid--white g-box-shadow__primary-v1 g-radius--circle g-margin-b-30--xs" src="{{ asset('23/img/400x400/06.jpg') }}" alt="Image">
                                <div class="g-margin-b-40--xs">
                                    <p class="g-font-size-22--xs g-font-size-28--sm g-font-family--playfair g-color--heading"><i>" I have purchased many great templates over the years but this product and this company have taken it to the next level. Exceptional customizability. "</i></p>
                                </div>
                                <div class="center-block g-hor-divider__solid--heading-light g-width-100--xs g-margin-b-30--xs"></div>
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                ...
                <div class="row">
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="{{ asset('23/img/970x970/01.jpg') }}" alt="Image">
                    ...
                    <div class="col-sm-4 g-margin-b-30--xs g-margin-b-0--md">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="{{ asset('23/img/970x970/02.jpg') }}" alt="Image">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                    ...
                    <div class="col-sm-4">
                        <!-- News -->
                        <article>
                            <img class="img-responsive" src="{{ asset('23/img/970x970/03.jpg') }}" alt="Image">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">Criminal Law</p>
        ...
        <div class="g-position--relative g-bg-color--primary">
            ...
            <img class="s-mockup-v2" src="{{ asset('23/img/mockups/pencil-01.png') }}" alt="Mockup Image">
        </div>
        <!-- End Feedback Form -->
        <!--========== END PAGE CONTENT ==========-->
        ...
        <script type="text/javascript" src="{{ asset('23/vendor/waypoint.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/vendor/counterup.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/vendor/cubeportfolio/js/jquery.cubeportfolio.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/vendor/jquery.parallax.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/vendor/jquery.equal-height.min.js') }}"></script>
        ...
        <script type="text/javascript" src="{{ asset('23/js/components/counter.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/js/components/parallax.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/js/components/tab.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/js/components/equal-height.min.js') }}"></script>
