                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="{{ route('template23.contacts') }}">Contacts</a></li>
                        </ul>
                        <!-- End Menu List -->
                    </div>
                </nav>
