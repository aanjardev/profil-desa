    ...
    <div class="container">
        <div class="g-text-center--xs">
            <div class="g-margin-t-40--xs g-margin-b-60--xs g-margin-b-80--sm s-header__emergency-contact">
                <h1 class="g-font-size-32--xs g-font-size-50--sm g-font-size-60--md g-margin-b-30--xs">Layanan Surat</h1>
                <p class="text-uppercase g-font-size-20--md g-font-weight--300">Daftar layanan surat untuk membantu masyarakat Desa.</p>
            </div>                
        </div>
    </div>
