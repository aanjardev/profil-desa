...
<div class="g-bg-color--sky-light g-padding-y-60--xs" style="background-color: #f8fafc !important;">
    <div class="container">
        ...
        <div class="row" style="display: flex; flex-wrap: wrap;">
            <!-- Sidebar Info -->
            <div class="col-md-4 g-margin-b-30--xs">
            ...
            <div class="col-md-8">
                ...
                @if($umkm->main_image)
                <div class="g-margin-b-40--xs" style="border-radius: 16px; overflow: hidden; box-shadow: 0 15px 40px rgba(0, 0, 0, 0.04); border: 1px solid #e2e8f0;">
                ...
                <div class="umkm-details-box">
                    ...
                    <div class="g-margin-t-40--xs">
                        <h3 class="g-font-size-18--xs g-font-weight--700 g-margin-b-20--xs" style="color: #1e293b; font-family: 'Montserrat', sans-serif;">Fasilitas / Layanan</h3>
                        <div class="row">
                    ...
                    <div class="row" style="display: flex; flex-wrap: wrap;">
                        @foreach($umkm->supporting_images as $image)
                            ...
                            <div class="col-sm-6 col-md-4 g-margin-b-20--xs">
                                <a href="{{ asset('storage/'.$imagePath) }}" target="_blank" class="gallery-card" title="{{ $imageCaption }}">
