<style>
    ...
    /* === Section Wisata: abu-abu (kontras dengan Berita yg putih) === */
    .section-wisata {
        background-color: #f5f5f5;
        padding: 80px 0 90px;
    }

    /* === Section UMKM: abu-abu (kontras dengan Agenda yg putih) === */
    .section-umkm {
        background-color: #f5f5f5;
        padding: 80px 0 90px;
...
<section class="section-wisata">
    <div class="container">
        <div class="g-text-center--xs g-margin-b-50--xs">
            <h2 class="g-font-size-26--xs g-font-size-36--sm g-font-weight--700" style="color:#1a1a1a; margin-bottom:0;">Tempat Wisata</h2>
        ...
        <div class="row row-flex g-margin-b-30--xs" style="justify-content: center;">
            @forelse($wisata as $w)
            <div class="col-sm-4 col-xs-12 g-margin-b-30--xs" style="display: flex; padding-bottom: 30px;">
        ...
        @if($wisata->count() > 0)
        <div class="text-center g-margin-t-10--xs">
...
<section class="section-umkm">
    <div class="container">
        <div class="g-text-center--xs g-margin-b-50--xs">
            <h2 class="g-font-size-26--xs g-font-size-36--sm g-font-weight--700" style="color:#1a1a1a; margin-bottom:0;">Produk Unggulan UMKM</h2>
            <span class="section-title-divider"></span>
