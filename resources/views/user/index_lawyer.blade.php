...
@section('content')
        <!--========== PROMO BLOCK ==========-->
        <div class="g-fullheight--xs js__parallax-window" style="background: url('{{ asset('23/img/1920x1080/11.jpg') }}') 50% 0 no-repeat fixed; background-size: cover;">
        ...
        <!-- Parallax -->
        <div class="js__parallax-window" style="background: url('{{ asset('23/img/1920x1080/12.jpg') }}') 50% 0 no-repeat fixed;">
        ...
        <div class="container g-margin-t-o-100--xs g-margin-b-125--xs">
            <div class="row g-row-col--0">
                <div class="col-sm-6">
                    <!-- Filter -->
                    <div class="g-bg-position--center g-padding-x-30--xs g-padding-x-40--sm g-padding-y-30--xs g-padding-y-40--sm js__tab-eqaul-height-v1" style="background: url('{{ asset('23/img/970x970/04.jpg') }}') no-repeat;">
