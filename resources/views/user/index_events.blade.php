...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <!-- Theme Skins -->
        <link href="{{ asset('23/css/theme/red.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <body>
                        ...
                        <div class="s-header__navbar-row-col">
                            ...
                            <div class="s-header__logo">
                                <a href="{{ route('template23.index') }}" class="s-header__logo-link">
                                    <img class="s-header__logo-img s-header__logo-img-default" src="{{ asset('23/img/logo-red.png') }}" alt="Megakit Logo">
                                    <img class="s-header__logo-img s-header__logo-img-shrink" src="{{ asset('23/img/logo-red-dark.png') }}" alt="Megakit Logo">
                                </a>
                            </div>
                            <!-- End Logo -->
                        </div>
                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            ...
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider -is-active" href="{{ route('template23.index-events') }}">Events</a></li>
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--sm" style="background: url('{{ asset('23/1920x1080/09.jpg') }}');">
                    ...
                    <div class="col-md-6 col-md-pull-5">
                        ...
                        <div class="row g-row-col--5 js__masonry">
                            ...
                            <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs js__masonry-item">
                                <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/500x750/01.jpg') }}" alt="Image">
                            </div>
                            <div class="col-xs-6 g-full-width--xs g-margin-t-25--md g-margin-b-10--xs js__masonry-item">
                                <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/450x215/01.jpg') }}" alt="Image">
                            </div>
                            <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs js__masonry-item">
                                <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/500x750/02.jpg') }}" alt="Image">
                            </div>
                            <div class="col-xs-6 g-full-width--xs g-margin-b-10--xs js__masonry-item">
                                <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/450x295/01.jpg') }}" alt="Image">
                            </div>
                        </div>
                        <!-- End Masonry Grid -->
                    </div>
        ...
        <!-- Upcoming Event -->
        <div class="s-promo-block-v2 js__parallax-window" style="background: url('{{ asset('23/1920x1080/03.jpg') }}') 50% 0 no-repeat fixed; background-size: cover;">
            <div class="container">
                ...
                <div class="row g-overflow--hidden">
                    <div class="col-xs-6 g-full-width--xs g-margin-b-30--xs g-margin-b-0--lg">
                        ...
                        <div class="center-block g-box-shadow__dark-lightest-v1 g-width-100-percent--xs g-width-400--lg">
                            <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/400x400/02.jpg') }}" alt="Image">
                    ...
                    <div class="col-xs-6 g-full-width--xs">
                        <!-- Speaker -->
                        <div class="center-block g-box-shadow__dark-lightest-v1 g-width-100-percent--xs g-width-400--lg">
                            <img class="img-responsive g-width-100-percent--xs" src="{{ asset('23/img/400x400/01.jpg') }}" alt="Image">
                            <div class="g-position--overlay g-padding-x-30--xs g-padding-y-30--xs g-margin-t-o-60--xs">
                                <div class="g-bg-color--primary g-padding-x-15--xs g-padding-y-10--xs g-margin-b-20--xs">
        ...
        <script type="text/javascript" src="{{ asset('23/vendor/masonry/jquery.masonry.pkgd.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/vendor/masonry/imagesloaded.pkgd.min.js') }}"></script>
        ...
        <script type="text/javascript" src="{{ asset('23/js/components/masonry.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/js/components/parallax.min.js') }}"></script>
        <script type="text/javascript" src="{{ asset('23/js/components/google-map2.min.js') }}"></script>
