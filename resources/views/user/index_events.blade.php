...
@section('content')
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--sm" style="background: url('{{ asset('23/img/1920x1080/09.jpg') }}');">
        ...
        <!-- Upcoming Event -->
        <div class="s-promo-block-v2 js__parallax-window" style="background: url('{{ asset('23/img/1920x1080/03.jpg') }}') 50% 0 no-repeat fixed; background-size: cover;">
            <div class="container">
