...
<header
    ...
    <div class="flex items-center justify-between w-full px-4 py-3 xl:px-6 lg:py-4">
        
        <!-- Left Side: Toggles, Title, Logo -->
        <div class="flex items-center gap-3">
            <!-- Mobile Menu Toggle Button (visible below xl) -->
            <button
                class="flex xl:hidden items-center justify-center w-10 h-10 text-gray-500 rounded-lg"
            ...
            <div class="hidden xl:flex flex-col ml-4">
                <h1 class="text-base font-bold text-gray-800 leading-tight">@yield('page_title', $title ?? 'Dashboard')</h1>
                @hasSection('page_subtitle')
                    <p class="text-[11px] text-gray-400 leading-normal mt-0.5">@yield('page_subtitle')</p>
                @endif
            </div>
        ...
        <!-- Right Side: User Dropdown (mobile & desktop) -->
